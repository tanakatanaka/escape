...
//	#endif
	...
	public:
		...
		D_CBaseFilter( TCHAR       *pName, IUnknown * pUnk, D_CCritSec  *pLock, REFCLSID   clsid, HRESULT   *phr);
#ifdef UNICODE
...
//	#endif
	...
	public:
//		D_CMediaSample( TCHAR *pName, class D_CBaseAllocator *pAllocator, HRESULT *phr, LPBYTE pBuffer = NULL, LONG length = 0);
//	#ifdef UNICODE
		D_CMediaSample( CHAR *pName, class D_CBaseAllocator *pAllocator, HRESULT *phr, LPBYTE pBuffer = NULL, LONG length = 0);
//	#endif
	...
	public:
		D_CBaseAllocator( TCHAR *, IUnknown *, HRESULT *, BOOL bEvent = TRUE, BOOL fEnableReleaseCallback = FALSE);
	#ifdef UNICODE
		D_CBaseAllocator( CHAR *, IUnknown *, HRESULT *, BOOL bEvent = TRUE, BOOL fEnableReleaseCallback = FALSE);
	#endif
	...
	public:
		...
		STDMETHODIMP			  SetProperties				( D_ALLOCATOR_PROPERTIES* pRequest, D_ALLOCATOR_PROPERTIES* pActual);
//		D_CMemAllocator(TCHAR *, IUnknown *, HRESULT *);
//#ifdef UNICODE
		D_CMemAllocator(CHAR *, IUnknown *, HRESULT *);
//#endif
		~D_CMemAllocator();
	};
	...
	public:
		...
		D_CAsyncReader( TCHAR *pName, IUnknown * pUnk, D_CAsyncStream *pStream, HRESULT *phr);
		~D_CAsyncReader();
