...
/* get function: bed of class  Room */
static int tolua_get_Room_Room_bed(lua_State* tolua_S)
{
  Room* self = (Room*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: bed of class  Room */
static int tolua_set_Room_Room_bed(lua_State* tolua_S)
{
  Room* self = (Room*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->bed = ((int)  tolua_tonumber(tolua_S,2,0));
 return 0;
}

/* get function: makura of class  Room */
static int tolua_get_Room_Room_makura(lua_State* tolua_S)
{
  Room* self = (Room*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'makura'",NULL);
#endif
 tolua_pushnumber(tolua_S,(lua_Number)self->makura);
 return 1;
}

/* set function: makura of class  Room */
static int tolua_set_Room_Room_makura(lua_State* tolua_S)
{
  Room* self = (Room*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->makura = ((int)  tolua_tonumber(tolua_S,2,0));
 return 0;
}

/* get function: huton of class  Room */
static int tolua_get_Room_Room_huton(lua_State* tolua_S)
{
  Room* self = (Room*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'huton'",NULL);
#endif
 tolua_pushnumber(tolua_S,(lua_Number)self->huton);
 return 1;
}

/* set function: huton of class  Room */
static int tolua_set_Room_Room_huton(lua_State* tolua_S)
{
  Room* self = (Room*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->huton = ((int)  tolua_tonumber(tolua_S,2,0));
 return 0;
}
...
/* get function: paper3 of class  Room */
static int tolua_get_Room_Room_paper3(lua_State* tolua_S)
{
  Room* self = (Room*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* set function: paper3 of class  Room */
static int tolua_set_Room_Room_paper3(lua_State* tolua_S)
{
  Room* self = (Room*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->paper3 = ((int)  tolua_tonumber(tolua_S,2,0));
 return 0;
}
...
/* get function: game_end of class  Player */
static int tolua_get_Player_Player_game_end(lua_State* tolua_S)
{
  Player* self = (Player*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'game_end'",NULL);
#endif
 tolua_pushboolean(tolua_S,(bool)self->game_end);
 return 1;
}

/* set function: game_end of class  Player */
static int tolua_set_Player_Player_game_end(lua_State* tolua_S)
{
  Player* self = (Player*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 ...
 tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->game_end = ((bool)  tolua_toboolean(tolua_S,2,0));
 return 0;
}

/* function: Player_get_end */
static int tolua_lua_header_Player_get_end00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  Player* self = ((Player*)  tolua_tousertype(tolua_S,1,0));
 {
  bool tolua_ret = (bool)  Player_get_end(self);
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'Player_get_end'.",&tolua_err);
 return 0;
#endif
}
...
LUALIB_API int luaopen_lua_header (lua_State* tolua_S)
{
 ...
 tolua_variable(tolua_S,"paper3",tolua_get_Room_Room_paper3,tolua_set_Room_Room_paper3);
 ...
 tolua_variable(tolua_S,"game_end",tolua_get_Player_Player_game_end,tolua_set_Player_Player_game_end);
 tolua_endmodule(tolua_S);
 tolua_function(tolua_S,"Player_get_end",tolua_lua_header_Player_get_end00);
